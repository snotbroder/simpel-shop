    ...
    <div className="h-full">
      ...
      <div className="text-primary flex flex-col md:flex-row justify-center gap-20 items-center py-4">
        <div className="md:max-w-xl">
          <h2 className="font-poppins font-bold text-2xl md:text-4xl my-3  ">Everything you need at once</h2>
          <div className=" ">
        ...
        <div>
          <Image src="/indeximg.avif" width={460} height={460} alt="cardboardbox covered man" />
        </div>
      </div>
    </div>
  );
