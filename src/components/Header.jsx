...
function Header() {
  return (
    <header className="bg-primary p-4 md:px-20 font-poppins text-primary mb-5">
      <nav className="flex justify-between items-center">
        ...
        <Link
          href={`/checkout`}
          className="relative group cursor-pointer font-noto text-secondary text-2xl font-semibold	"
        >
          <BsBag />
